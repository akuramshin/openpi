...
def run_test(args: Args) -> None:
    ...
    # # save the policy input to a pickle file
    # import pickle
    # with open('policy_input.pkl', 'wb') as f:
    #     pickle.dump(policy_input, f)
...
def construct_policy_input(obs, task_description, img_resize_size):
    """
...
def sample_k_action_chunks(policy_client, k, element):
    """
    Sample k action chunks from the policy.
    ...
    policy_client: PolicyClient
        The policy client.
    k: int
        The number of action chunks to sample.
    element: dict
        A policy input element.
